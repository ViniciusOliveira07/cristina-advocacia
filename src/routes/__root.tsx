  ...
  head: () => ({
    meta: [
      ...
      { title: "Cristina Morgado Advocacia | Direito do Trabalho, Civil e Família em SP" },
      {
        name: "description",
        content:
          "Escritório de advocacia em São Paulo com atendimento personalizado em Direito do Trabalho, Civil e de Família.",
      },
      { name: "author", content: "Cristina Morgado Advocacia" },
      { property: "og:site_name", content: "Cristina Morgado Advocacia" },
